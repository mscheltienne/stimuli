...
@fill_doc
def _init_logger(*, verbose: Optional[bool | str | int] = None) -> logging.Logger:
    """Initialize a logger.
...
def add_file_handler(
    ...
    *,
    verbose: Optional[bool | str | int] = None,
) -> None:
...
@fill_doc
def set_log_level(verbose: Optional[bool | str | int]) -> None:
...
class _use_log_level:
    ...
    def __init__(self, verbose: Optional[bool | str | int] = None):
