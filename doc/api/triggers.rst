...
:class:`~stimuli.triggers.LSLTrigger` which uses a trigger value between 1 and 127).
...
This converter can be used with the :class:`~stimuli.triggers.ParallelPortTrigger` class
